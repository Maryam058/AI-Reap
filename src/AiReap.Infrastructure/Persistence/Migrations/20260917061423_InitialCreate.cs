        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromptTemplateVersion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InputReference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OutputJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Accepted = table.Column<bool>(type: "bit", nullable: true),
                    ProducedArtifactId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIExecutions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessProblem = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    TechnologyPreferences = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Constraints = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExpectedTimeline = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequirementSources", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequirementSources_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequirementSourceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Artifacts_RequirementSources_RequirementSourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetArtifactId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArtifactRelationships_Artifacts_SourceArtifactId",
                        column: x => x.SourceArtifactId,
                        principalTable: "Artifacts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArtifactRelationships_Artifacts_TargetArtifactId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArtifactReviews_Artifacts_ArtifactId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtifactRelationships_SourceArtifactId_RelationshipType_TargetArtifactId",
                table: "ArtifactRelationships",
                columns: new[] { "SourceArtifactId", "RelationshipType", "TargetArtifactId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ArtifactRelationships_TargetArtifactId",
                table: "ArtifactRelationships",
                column: "TargetArtifactId");

            migrationBuilder.CreateIndex(
                name: "IX_ArtifactReviews_ArtifactId",
                table: "ArtifactReviews",
                column: "ArtifactId");

            migrationBuilder.CreateIndex(
                name: "IX_Artifacts_ProjectId_ArtifactType_Code",
                table: "Artifacts",
                columns: new[] { "ProjectId", "ArtifactType", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Artifacts_RequirementSourceId",
                table: "Artifacts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequirementSources_ProjectId",
                table: "RequirementSources",
                column: "ProjectId");
        }
